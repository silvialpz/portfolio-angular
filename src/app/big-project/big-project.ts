    ...
    <div class="m-16"> 
      <div class="bg-[#265F5B] 
        ...
        <div class="w-full md:w-1/3 
                    p-8 md:p-12 lg:pl-20 
                    flex flex-col items-center md:items-start 
                    justify-center 
                    text-center md:text-left">
        <h2 class="text-violet-50 text-4xl md:text-5xl font-bold mb-4 md:mb-5">UofT Code Buddy</h2>
        <p class="text-violet-100 text-lg md:text-2xl mb-6">AI extension provides plagiarism-free tutoring feedback to programming students </p>
